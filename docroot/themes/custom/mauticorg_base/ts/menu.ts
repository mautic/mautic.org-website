($ => {
  ...
  function checkOffset() {
    if (
      $(".header--container").offset().top + $(".header--container").height() >=
      106
    ) {
  ...
  $(".block-views-exposed-filter-blockacquia-search-page-1 h2").click(
    function() {
      $(".block-views-exposed-filter-blockacquia-search-page-1").toggleClass(
        "search--visible"
      );

      $(
        ".block-views-exposed-filter-blockacquia-search-page-1 .form-autocomplete"
      ).focus();
    }
  );
})(jQuery);
