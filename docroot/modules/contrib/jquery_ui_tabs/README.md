...
jQuery UI Tabs library for any themes and modules that require
it.

  - jQuery UI [Tabs documentation](https://jqueryui.com/tabs/)
  - jQuery UI [Tabs API documentation](https://api.jqueryui.com/tabs/)
