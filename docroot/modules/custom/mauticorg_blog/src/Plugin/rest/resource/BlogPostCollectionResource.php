...
/**
 * Provides a blog post collection resource.
 *
 * @RestResource(
 *   id = "mauticorg_blog_collection",
 *   label = @Translation("Mautic Blog Collection"),
 *   uri_paths = {
 *     "canonical" = "/blog/rss.xml",
 *   }
 * )
 */
class BlogPostCollectionResource extends ResourceBase {
  ...
  public function get(): ResourceResponse {
    return $this->createResponse($this->repository->findAll());
  }
